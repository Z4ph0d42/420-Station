/obj/machinery/smelter
	...
	base_type = /obj/machinery/smelter
...
/obj/machinery/smelter/proc/result_materials(obj/O)
	if(istype(O, /obj/item/weapon/ore))
		...
		var/material/data = SSmaterials.materials[ore.material]
		//var/ore/data = ore_data[ore.material]
		if(data.ore_smelts_to)
			return list(data.ore_smelts_to = 1)
		if(data.ore_compresses_to)
			return list(data.ore_compresses_to = 1)
	return O.get_matter()
...
/obj/machinery/smelter/proc/eject_material_stack(material)
	...
	if(!M)
		return
	var/obj/item/stack/material/stack_type = M.stack_type
...
/obj/machinery/smelter/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 2)
