...
/obj/machinery/sorter
	...
	base_type = /obj/machinery/sorter
...
/obj/machinery/sorter/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 2, datum/topic_state/state = GLOB.default_state)
...
/obj/item/weapon/stock_parts/circuitboard/sorter
	name = T_BOARD("sorter")
