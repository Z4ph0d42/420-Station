...
/decl/cultural_info/faction/torchco
	...
	backers who asssisted in funding the Zerzura project when it opened five years ago. Major players include NanoTrasen, Xynergy and \
...
/decl/cultural_info/faction/dais
	...
	few corporate members of the Solar Assembly. DAIS is also a major investor in the Zerzura project, and is on the Expeditionary Corps Organization board of directors. \
