...
/datum/computer_file/report/recipient/crew_transfer/generate_fields()
	...
	add_field(/datum/report_field/text_label/header, "SEV Torch - Office of The First Mate")
	...
	xo_fields += add_field(/datum/report_field/signature, "First Mate's signature")
