//Zerzura ID Cards (they have to be here to make the outfits work, no way around it)

/obj/item/weapon/card/id/torch
	name = "identification card"
	desc = "An identification card issued to personnel aboard the CEV Zerzura."
...
/obj/item/weapon/card/id/torch/crew
	desc = "An identification card issued to SolGov crewmembers aboard the CEV Zerzura."
	color = "#d3e3e1"
...
/obj/item/weapon/card/id/torch/contractor
	desc = "An identification card issued to private contractors aboard the CEV Zerzura."
	job_access_type = DEFAULT_JOB_TYPE
	color = COLOR_GRAY80
...
/obj/item/weapon/card/id/torch/crew/research
	desc = "A card issued to science personnel aboard the CEV Zerzura."
...
/obj/item/weapon/card/id/torch/passenger
	desc = "A card issued to passengers aboard the CEV Zerzura."
	job_access_type = DEFAULT_JOB_TYPE
	detail_color = COLOR_PAKISTAN_GREEN

/obj/item/weapon/card/id/torch/passenger/research
	desc = "A card issued to corporate personnel aboard the CEV Zerzura."
	job_access_type = /datum/job/scientist_assistant
