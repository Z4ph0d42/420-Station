/decl/hierarchy/outfit/job/torch
	name = OUTFIT_JOB_NAME("Zerzura Outfit")
...
/decl/hierarchy/outfit/job/torch/crew
	name = OUTFIT_JOB_NAME("Zerzura Crew Outfit")
...
/decl/hierarchy/outfit/job/torch/crew/fleet
	name = OUTFIT_JOB_NAME("Zerzura Fleet Outfit")
...
/decl/hierarchy/outfit/job/torch/passenger
	name = OUTFIT_JOB_NAME("Zerzura Passenger")
