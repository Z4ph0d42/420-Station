...
/datum/map/torch/get_map_info()
	. = list()
	. +=  "You're aboard the " + replacetext("<b>[station_name]</b>", "\improper", "") + ", an aging generational ship who's original purpose has been lost to time. Its current general mission is profit and exploration of new, exploitable resources in deep space."
